/**
 * Receiver for 选词填空（2024） only. NOT deployed by committing this file.
 ...
 */
const VCFG={sheetId:'1XWGz1BBY4K5AfVsmZSYnqxXvlie2j2wiVFV0ZRF0-VE',lessonId:'2hcl-xuanci-2024',title:'中二选词填空（2024）',protocol:'hwt-vocab-progress-v1',progress:'选词填空2024-进度',details:'选词填空2024-逐题'};
...
const VANS={"16":["啧啧称奇"],"17":["人云亦云"],"18":["初来乍到"],"19":["高瞻远瞩"],"20":["心旷神怡"],"21":["社交媒体"],"22":["闪烁其词"],"23":["魂不守舍"],"24":["络绎不绝"],"25":["名列前茅"],"26":["抛砖引玉"],"27":["逆水行舟"],"28":["富裕"],"29":["潜移默化"],"30":["情同手足"]};
