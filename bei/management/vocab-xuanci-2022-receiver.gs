/**
 * Receiver for 选词填空（2022） only. NOT deployed by committing this file.
 ...
 */
const VCFG={sheetId:'1XWGz1BBY4K5AfVsmZSYnqxXvlie2j2wiVFV0ZRF0-VE',lessonId:'2hcl-xuanci-2022',title:'选词填空（2022）',protocol:'hwt-vocab-progress-v1',progress:'选词填空2022-进度',details:'选词填空2022-逐题'};
...
const VANS={"16":["络绎不绝"],"17":["睿智"],"18":["面面俱到"],"19":["潜移默化"],"20":["豁然开朗"],"21":["惬意"],"22":["旗鼓相当"],"23":["逆水行舟"],"24":["闪烁其词"],"25":["扣人心弦"],"26":["煞费苦心"],"27":["囫囵吞枣"],"28":["咎由自取"],"29":["墨守成规"],"30":["简陋"]};
